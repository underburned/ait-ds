...
- Для снижения дисбаланса классов воспользоваться любым методом любым методом из [Дисбаланс классов](../self-study/class_imbalance.md) или любым другим способом.
